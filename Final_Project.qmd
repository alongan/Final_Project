...
**need to add updated graphs and table in here and copy this into the portfolio**
...
### Correlogram of important variables against each other
```{r}
#| label: correlogram-important predictors
 
cor_data <- cor(macrophytes_final[,7:22], use = "complete.obs") #specifying cor data
